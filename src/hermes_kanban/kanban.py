...
def _check_dispatcher_presence() -> tuple[bool, str]:
    ...
    try:
        from hermes_kanban._adapters import load_config
        cfg = load_config()
...
def _profile_author() -> str:
    ...
    for env in ("HERMES_PROFILE_NAME", "HERMES_PROFILE"):
        ...
        if v:
            return v
    try:
        from hermes_kanban._adapters import get_active_profile_name
...
def _cmd_show(args: argparse.Namespace) -> int:
    ...
    # comments / runs.
    from hermes_kanban import kanban_diagnostics as kd
...
def _cmd_specify(args: argparse.Namespace) -> int:
    ...
    from hermes_kanban import kanban_specify as spec
